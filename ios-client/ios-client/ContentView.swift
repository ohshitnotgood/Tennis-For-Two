...
struct ContentView: View {
    ...
    @StateObject private var settings               = SettingsValueStore()
            ...
            List {
                Section {
                    HStack {
                        Text("Xpc, Ypc")
                        Spacer()
                        Text("\(kit.latestCoordinate.x), \(kit.latestCoordinate.y)")
                    ...
                    HStack {
                        Text("Acceleration")
                        Spacer()
                        Text("\(kit.latestCoordinate.acceleration)")
                            .foregroundColor(.secondary)
                            .monospaced()
                    }
                    ...
                    HStack {
                        Text("Tilt")
                        Spacer()
                        Text("\(kit.latestCoordinate.tilt)")
                            .foregroundColor(.secondary)
                            .monospaced()
                    }
                } header: {
                ...
                Section {
                    HStack {
                        Text("x")
                        Spacer()
                        Text("\(kit.latestCoordinate.gyro_x)")
                            .foregroundColor(.secondary)
                    }
                    ...
                    HStack {
                        Text("y")
                        Spacer()
                        Text("\(kit.latestCoordinate.gyro_y)")
                            .foregroundColor(.secondary)
                    }
                    ...
                    HStack {
                        Text("z")
                        Spacer()
                        Text("\(kit.latestCoordinate.gyro_z)")
                            .foregroundColor(.secondary)
                    }
                } header: {
